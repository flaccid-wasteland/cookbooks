...
application "#{node['rails_app']['name']}" do
  ...
  when "unicorn"
    unicorn do
      after_fork node['rails_app']['unicorn']['after_fork']
      before_exec node['rails_app']['unicorn']['before_exec']
      before_fork node['rails_app']['unicorn']['before_fork']
      copy_on_write node['rails_app']['unicorn']['copy_on_write']
      enable_stats node['rails_app']['unicorn']['enable_stats']
      forked_group node['rails_app']['unicorn']['forked_group']
      forked_user node['rails_app']['unicorn']['forked_user']
      group node['rails_app']['unicorn']['group']
      listen node['rails_app']['unicorn']['listen']
      mode node['rails_app']['unicorn']['mode']
      notifies node['rails_app']['unicorn']['notifies']
      owner node['rails_app']['unicorn']['owner']
      pid node['rails_app']['unicorn']['pid']
      port node['rails_app']['unicorn']['port']
      preload_app node['rails_app']['unicorn']['preload_app']
      stderr_path node['rails_app']['unicorn']['stderr_path']
      ...
      working_directory node['rails_app']['unicorn']['working_directory']
